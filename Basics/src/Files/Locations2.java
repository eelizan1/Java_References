    ...
    static {
        ...
        try {
            ...
            while(scanner.hasNextLine()) {
                ...
                scanner.skip(scanner.delimiter());
                // read destination
                String dest = scanner.nextLine(); // note: nextLine() means read till end of line
                int destination = Integer.parseInt(dest); // convert to int
                System.out.println(location2 + " : " + direction + " : " + destination);

                // Store in map object
                Location location = locations.get(location2);
